...
/**
 * Command to begin receiving message.
...
public class MessageCommand extends BotCommand {
    ...
    public MessageCommand(TelegramBot bot) {
        super("message", "Begin to recieve message");
        this.bot = bot;
    }
    ...
    public void execute(AbsSender absSender, User user, Chat chat, String[] arguments) {
        ...
        LOGGER.info("Start to recieving message from user {} on chat {}", userName, chat.getId());
        ...
        bot.sendAnswer(absSender, chat.getId(), "/message", userName, message.getStatus().getLabel());
    }
