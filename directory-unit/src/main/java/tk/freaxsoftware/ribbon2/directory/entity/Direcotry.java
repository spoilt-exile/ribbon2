...
public class Direcotry extends Model {
     ...
     */
    @DbJsonB
    private Set<DirectoryModel.AccessEntry> access;
    ...
    public Set<DirectoryModel.AccessEntry> getAccess() {
        return access;
    }

    public void setAccess(Set<DirectoryModel.AccessEntry> access) {
        this.access = access;
    }
}
